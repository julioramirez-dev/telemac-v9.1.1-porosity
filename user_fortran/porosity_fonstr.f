...
!! @param[in,out] Z            FREE SURFACE ELEVATION
!! @param[in,out] CHESTR       FRICTION COEFFICIENT (DEPENDING ON FRICTION LAW)
!! @param[in]     NGEO         LOGICAL UNIT OF GEOMETRY FILE
!! @param[in]     FFORMAT
!! @param[in]     NFON         LOGICAL UNIT OF BOTTOM FILE
!! @param[in]     NOMFON       NAME OF BOTTOM FILE
!! @param[in]     MESH         MESH STRUCTURE
!! @param[in]     FFON         FRICTION COEFFICIENT IF CONSTANT
!! @param[in]     LISTIN       IF YES, WILL GIVE A REPORT
!! @param[in]     N_NAMES_PRIV NUMBER OF PRIVATE ARRAYS WITH GIVEN NAMES
!! @param[in]     NAMES_PRIVE
!! @param[in,out] PRIVE        BLOCK OF PRIVATE ARRAYS
      SUBROUTINE FONSTR
     &(H,ZF,Z,CHESTR,NGEO,FFORMAT,NFON,NOMFON,MESH,FFON,LISTIN,
     & N_NAMES_PRIV,NAMES_PRIVE,PRIVE)
!
      USE BIEF, EX_FONSTR => FONSTR
      USE MOD_FIND_VARIABLE
